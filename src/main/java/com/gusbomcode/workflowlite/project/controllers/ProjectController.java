package com.gusbomcode.workflowlite.project.controllers;
...
public class ProjectController {
    ...
    public ResponseEntity<Api_Response<ProjectResponse>> updateStatus(@PathVariable long id, @RequestBody ProjectStatus request){
